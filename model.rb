...
class Movie < Sequel::Model
  ...
  many_to_many :genres, join_table: :movie_genre
end

class Productioncompany < Sequel::Model
  many_to_many :movies, class: :Movie, join_table: :movie_productioncompany
end

class Genre < Sequel::Model
  many_to_many :movies, class: :Movie, join_table: :movie_genre
end